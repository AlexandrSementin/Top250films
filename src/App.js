...
const movieApi = 'https://imdb-api.com/en/API/SearchMovie/k_v96im1yq/'
const movieTop = 'https://imdb-api.com/en/API/Top250Movies/k_v96im1yq/'
...
function App() {
  ...
  return (
    <>
        <header>
          <h1 className='hed'>Top 250 best films</h1>
